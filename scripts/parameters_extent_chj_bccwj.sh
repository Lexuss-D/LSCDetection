...
typesnorms=(72265 61666) # normalization constants for number of context types (total number of types in first and second corpus)
...
#goldrankfile="testsets/extent_jp/chj_bccwj/rank_reverse_compare.tsv" # file with gold scores for target words in same order as targets in testsets
goldrankfile="testsets/extent_jp/chj_bccwj/rank_absDlater.tsv" # file with gold scores for target words in same order as targets in testsets
